...
public class CalculatorDemo {
	...
	public static void main(String[] args) {
		...
		do {
			...
			if (!operation.equals("=") && !operation.equals("?") && !operation.equals("neg") && !operation.equals("%") && !operation.equals("rand") && !operation.equals("c") && !operation.equals("C")) // don't get a number in these cases...
